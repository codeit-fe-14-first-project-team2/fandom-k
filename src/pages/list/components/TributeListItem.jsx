...
import { formatDonations, formatTimeBefore, getDonationProgress } from "../../../util/donation";
...
export default function TributeListItem(donation) {
	const { title, idol, receivedDonations, targetDonation, subtitle, deadline } = donation;
	...
	const handleOpenModal = (e) => {
		...
		setModal(<TributeModal donationIdol={donation} onDonationSuccess={handleDonationSuccess} />);
	};
